        ...
        <form novalidate>
          <div className="col-12 mb-5 bg-white shadow pb-3 px-4">
            ...
            <div className="w-100 d-flex flex column justify-content-center mt-3 flex-column align-items-center">
              ...
              <input className="form-control form-control-lg w-100" type="number" onChange={(e) => setnewpin(e.target.value)} required/>
              <label className="form-label my-2 text-start w-100 fs-4">Confirm pin</label>
              <input className="form-control form-control-lg w-100"  type="number" onChange={(e) => setconfirmpin(e.target.value)} required/>
            </div>
