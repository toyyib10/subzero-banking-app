      ...
      <nav id="sidebarMenu" className="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse p-4">
        <div className="position-sticky pt-3">
          ...
          <ul className="nav nav-pills flex-column mb-4">
            ...
            <li>
              <Link to="/dashboard/quickaction" className="nav-link text-secondary">
            ...
            <li>
              <Link to="/dashboard/wallets"className="nav-link text-secondary">
            ...
            <li>
              <Link to="/dashboard/history" className="nav-link text-secondary">
