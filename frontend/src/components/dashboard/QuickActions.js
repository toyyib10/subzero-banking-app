  ...
  return (
    <div className="bg-white shadow w-100 h-100 p-1 pt-md-2  pt-3 d-flex flex-wrap rounded-1">
      ...
      <div className="m-md-1 m-0" style={style}>
        <Actions svg={<svg className="mb-2" xmlns="http://www.w3.org/2000/svg" width="3.3em" height="3.3em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16"><path fill="currentColor" d="M2.5 13.5A.5.5 0 0 1 3 13h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zM2 2h12s2 0 2 2v6s0 2-2 2H2s-2 0-2-2V4s0-2 2-2z"/></svg>} name={"Cable TV"} navigateTo = {"/dashboard/quickaction/buysubcription"}/>
      </div>
